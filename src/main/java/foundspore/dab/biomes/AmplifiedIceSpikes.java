...
public class AmplifiedIceSpikes extends Biome {
    ...
    static final double DEPTH = ConfigManager.amplifiedicespikes.getDepth();
    static final double SCALE = ConfigManager.amplifiedicespikes.getScale();
    ...
    public AmplifiedIceSpikes() {
        ...
        this.func_226711_a_(Feature.VILLAGE.func_225566_b_(new VillageConfig("village/snowy/town_centers", 30)));
