...
public class AmplifiedGiantSpruceTaiga extends Biome {
    ...
    static final double DEPTH = ConfigManager.amplifiedgiantsprucetaiga.getDepth();
    static final double SCALE = ConfigManager.amplifiedgiantsprucetaiga.getScale();
    ...
    public AmplifiedGiantSpruceTaiga() {
        ...
        Main.LOGGER.info("Amplified Giant Spruce Taiga loaded");
    }
