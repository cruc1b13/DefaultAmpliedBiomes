...
public class AmplifiedBirchForest extends Biome {
    ...
    static final double DEPTH = ConfigManager.amplifiedbirchforest.getDepth();
    static final double SCALE = ConfigManager.amplifiedbirchforest.getScale();
    static final float TEMPERATURE = 0.6F;
    static final float DOWNFALL = 0.6F;
    static final int WATER_COLOR = 4159204;
    static final int WATER_FOG_COLOR = 329011;
    static final String PARENT = "birch_forest";

    public AmplifiedBirchForest() {
        ...
        Main.LOGGER.info("Amplified Birch Forest loaded");
