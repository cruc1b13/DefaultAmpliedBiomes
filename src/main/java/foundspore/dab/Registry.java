...
public class Registry {
    ...
    public static void registerBiomes(RegistryEvent.Register<Biome> event) {
        ...
        registerBiome(registry, new AmplifiedSavanna(), "amplifiedsavanna", ConfigManager.amplifiedsavanna.getWeight(), true, BiomeManager.BiomeType.ICY, BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.COLD, BiomeDictionary.Type.CONIFEROUS);
        registerBiome(registry, new AmplifiedSnowyTaiga(), "amplifiedsnowytaiga", ConfigManager.amplfiedsnowytaiga.getWeight(), true, BiomeManager.BiomeType.ICY, BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.COLD, BiomeDictionary.Type.CONIFEROUS);
