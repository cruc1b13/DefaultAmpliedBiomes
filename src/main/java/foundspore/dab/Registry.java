...
public class Registry {
    ...
    public static void registerBiomes(RegistryEvent.Register<Biome> event) {
        ...
        registerBiome(registry, new AmplifiedSavanna(), "amplifiedsavanna", ConfigManager.amplifiedsavanna.getWeight(), true, BiomeManager.BiomeType.DESERT, BiomeDictionary.Type.HOT, BiomeDictionary.Type.SAVANNA);
